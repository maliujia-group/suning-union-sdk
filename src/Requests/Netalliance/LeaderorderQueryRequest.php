 ...
 * 团长招商订单信息批量查询
 *
 * @link: https://open.suning.com/ospos/apipage/toApiMethodDetailMenu.do?interCode=suning.netalliance.leaderorder.query
 *
...
class LeaderorderQueryRequest implements Request
{
     ...
     * @var string
     */
    public $method = 'suning.netalliance.leaderorder.query';
     ...
     * @var string
     */
    public $bizName = 'queryLeaderorder';
