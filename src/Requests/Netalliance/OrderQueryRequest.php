...
class OrderQueryRequest implements Request
{
    ...
    private $promotion;   // 风控订单（1.风控订单）

    private $pid;       // 工具商pid

    private $orderChannel;   // 订单渠道号
    ...
    public function setOrderChannel($val)
    {
        $this->orderChannel = (string)$val;
        $this->apiParams['orderChannel'] = $this->orderChannel;
    }
